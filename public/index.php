...
$container->register(\App\Services\LitteringService::class, fn($c) => new \App\Services\LitteringService($c->resolve(\App\Repositories\LitteringRepository::class)));
...
$container->register(\App\Services\OrganizationService::class, fn($c) => new \App\Services\OrganizationService($c->resolve(\App\Repositories\DepartmentRepository::class), $c->resolve(\App\Repositories\PositionRepository::class)));
...
$container->register(\App\Services\ViewDataService::class, fn($c) => new \App\Services\ViewDataService($c->resolve(\App\Services\AuthService::class), $c->resolve(\App\Repositories\MenuRepository::class), $c->resolve(SessionManager::class)));
