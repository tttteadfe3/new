...
$router->group('/api', function($router) {
    ...
    $router->put('/littering_admin/reports/{id}/improvement-status', [LitteringAdminApiController::class, 'updateImprovementStatus'])->name('api.littering_admin.improvement-status')->middleware('auth')->middleware('permission', 'littering.approve');
