    ...
    <div class="col-lg-8 offset-lg-2">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">품목 정보 입력</h5>
            </div>
            <div class="card-body">
                <form id="item-form">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="item-code" name="item_code" required maxlength="50">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="min-stock-level" class="form-label">최소 재고 수준</label>
                                <input type="number" class="form-control" id="min-stock-level" name="min_stock_level" min="0" value="0">
                            </div>
                        </div>
                    </div>
