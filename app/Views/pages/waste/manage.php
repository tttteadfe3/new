...
<div class="row">
    <!-- Left Panel: Field Registrations -->
    <div class="col-lg-6">
        <h2>현장 등록</h2>
        <form id="fieldListForm" name="fieldListForm">
            ...
            <div class="search_box card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <input id="searchFieldAddress" name="searchFieldAddress" title="주소" placeholder="주소" class="form-control" type="text">
                        </div>
                        <div class="col-md-4">
                            <select id="searchFieldStatus" name="searchFieldStatus" class="form-select" title="처리여부">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 text-center">
                            <button type="button" id="searchFieldBtn" class="btn btn-primary">검색</button>
                            <button type="button" id="resetFieldBtn" class="btn btn-secondary">초기화</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <p>총 <span id="field-total-count" class="fw-bold">0</span>건의 데이터가 있습니다.</p>
    ...
    <!-- Right Panel: Online Registrations -->
    <div class="col-lg-6">
        <h2>인터넷 접수</h2>
