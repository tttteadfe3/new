...
class WasteCollectionController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        \App\Core\\App\Core\View::getInstance()->addJs(BASE_ASSETS_URL . "/assets/js/pages/waste-collection.js");
    ...
    {
        // Refactored Scripts
        \App\Core\\App\Core\View::getInstance()->addJs(BASE_ASSETS_URL . "/assets/js/pages/waste-admin.js");
