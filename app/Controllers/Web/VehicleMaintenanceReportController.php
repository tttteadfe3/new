...
class VehicleMaintenanceReportController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        View::getInstance()->addJs(BASE_ASSETS_URL . '/assets/js/pages/vehicle-maintenance-report.js');

        echo $this->render('pages/vehicle/maintenance-report', [
            'pageTitle' => '내 작업 관리'
        ], 'layouts/app');
    }
}
