...
class LeaveController extends BaseController
{
    ...
    public function approve(): void
    {
        ...
        try {
            $leaveId = (int)$this->request->input('leave_id');
            $user = $this->user();
            $adminUserId = $user['id'];

            [$success, $message] = $this->leaveService->approveRequest($leaveId, $adminUserId);
    ...
    public function reject(): void
    {
        ...
        try {
            ...
            [$success, $message] = $this->leaveService->rejectRequest($leaveId, $adminUserId, $reason);
    ...
    /**
     * Grant leave entitlements (bulk calculation)
     */
