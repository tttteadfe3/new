...
(400, NULL, '무단투기 관리', '/littering/map', 'ri-map-pin-user-line', 'littering.view', 40),
(401, 400, '무단투기 신고/처리', '/littering/map', 'ri-map-pin-add-line', 'littering.process', 10),
(402, 400, '검토 및 승인', '/littering', 'ri-user-shared-line', 'littering.confirm', 20),
