...
(302, 300, '인터넷배출 관리', '/waste/manage', 'ri-global-line', 'waste.manage_admin', 20),
...
(914, 910, '부서 관리', '/admin/organization', 'ri-building-4-line', 'organization.manage', 35),
(915, 910, '조직도', '/organization/chart', 'ri-node-tree', 'organization.view', 40),
(916, 910, '직급 관리', '/admin/positions', 'ri-award-line', 'organization.manage', 45),
