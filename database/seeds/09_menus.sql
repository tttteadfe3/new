...
(250, NULL, '연차 관리', '#', 'bx bx-calendar', '', 25),
(251, 250, '연차 대시보드', '/leaves/dashboard', 'bx bx-home-circle', '', 10),
(252, 250, '연차 신청', '/leaves/apply', 'bx bx-plus-circle', '', 20),
(253, 250, '팀 캘린더', '/leaves/team-calendar', 'bx bx-calendar-event', '', 30),
(254, 250, '관리자 대시보드', '/leaves/admin-dashboard', 'bx bx-bar-chart-alt-2', 'leave.view_all', 40),
(255, 250, '연차 승인', '/leaves/pending-approvals', 'bx bx-check-circle', 'leave.approve', 50),
(256, 250, '연차 부여', '/leaves/grant-leave', 'bx bx-gift', 'leave.manage_entitlement', 60),
(257, 250, '연차 관리', '/leaves/admin-management', 'bx bx-cog', 'leave.manage_entitlement', 70),
